...
#     @abstractmethod
#     async def generate(
#         self, request: GenerationRequest, cancel_token: CancelToken
#     ) -> str:
#         """Generate a single token with cancellation support."""
#         ...
...
#         cancel_token: CancelToken,
#     ) -> str:
#         """Generate a single token using OpenAI API."""
...
#                 else:
#                     raise LLMGenerationError("OpenAI generation failed")
...
#         cancel_token: CancelToken,
#     ) -> str:
#         """Generate a single token using Anthropic API."""
...
#                 else:
#                     raise LLMGenerationError("Anthropic generation failed")
#             except Exception as e:
